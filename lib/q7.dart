...
import 'package:jiltarjih/q8.dart';
        ...
        child: Column(
          children: [
            Center(
              ...
              buildAnswerOption('10'),
              buildAnswerOption('1024'),
              buildAnswerOption('1000'),
              buildAnswerOption('512'),
              SizedBox(
                height: MediaQuery.of(context).size.height / 25,
              ) ,
              Container(
